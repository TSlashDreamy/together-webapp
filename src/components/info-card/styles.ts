...
export const iconStyle = "xl:size-[2.7vw] size-[50px] fill-text-white";
export const headingStyle = "xl:text-[1.9vw] text-[36px]";
export const spanStyle = "font-normal opacity-80";
